...
// Guest-only login. Locale switching remains available before authentication.
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/appointments/quick-patient', [AppointmentController::class, 'quickPatient'])->name('appointments.quick-patient');
