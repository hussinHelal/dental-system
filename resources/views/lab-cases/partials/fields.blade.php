...
<div class="row g-3">
    <div class="col-md-6">
        <label class="form-label" for="labCasePatientSearch{{ $case?->id ?? 'new' }}">{{ __('dental_labs.patient') }} <span class="text-danger">*</span></label>
        <div class="position-relative" data-patient-autocomplete data-endpoint="{{ url('/lab-cases/patient-lookup') }}">
            <input type="text"
