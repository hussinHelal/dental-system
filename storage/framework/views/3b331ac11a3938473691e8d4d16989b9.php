    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2 shadow-sm p-3 rounded-4 zedan-page-header">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <p class="text-muted small mb-0"><?php echo e(__('messages.manage_staff_hint')); ?></p>
            </div>
        </div>
...
<?php endif; ?>
            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary text-nowrap">
                <i class="bi bi-person-plus-fill me-2"></i> <?php echo e(__('messages.add_staff')); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td data-label="<?php echo e(__('messages.role')); ?>">
                                        <span class="badge text-bg-<?php echo e($user->isDoctor() ? 'primary' : 'info'); ?>">
                                            <?php echo e($user->isDoctor() ? __('messages.doctor') : __('messages.receptionist')); ?>
                                    ...
                                    <td data-label="">
                                        <div class="d-flex gap-2">
                                            <a href="<?php echo e(route('users.edit', $user)); ?>" class="btn btn-sm btn-outline-primary" title="<?php echo e(__('messages.edit')); ?>">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form data-ajax-form method="POST" action="<?php echo e(route('users.toggle', $user)); ?>" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <button class="btn btn-sm btn-outline-secondary" title="<?php echo e($user->is_active ? __('messages.deactivate') : __('messages.activate')); ?>">
                                                    <i class="bi <?php echo e($user->is_active ? 'bi-person-x' : 'bi-person-check'); ?>"></i>
                                                </button>
                                            </form>
                                        </div>
                                    </td>
