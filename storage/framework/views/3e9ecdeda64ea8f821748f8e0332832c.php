...
?>
    <a href="<?php echo e(route('patients.index')); ?>" class="btn btn-sm btn-primary mb-2 shadow-sm">
        <i class="bi bi-arrow-<?php echo e(app()->getLocale() === 'ar' ? 'end' : 'start'); ?> icon-mirror-rtl me-1"></i>
        ...
        <div class="d-flex flex-wrap gap-1 justify-content-center">
            ...
            <div class="card zedan-card mb-4">
                <div class="card-header bg-transparent">
                    <i class="bi bi-x-ray me-2"></i><?php echo e(__('messages.xray_photo')); ?>

                </div>
                <div class="card-body text-center">
                    <a href="<?php echo e($patient->xrayPhotoUrl()); ?>" target="_blank" class="d-inline-block position-relative">
                        <img src="<?php echo e($patient->xrayPhotoUrl()); ?>" class="img-fluid rounded shadow-sm xray-image" alt="<?php echo e(__('messages.xray_photo')); ?>" style="max-height: 400px;">
                        <div class="position-absolute top-50 start-50 translate-middle bg-dark bg-opacity-50 rounded px-2 py-1 text-white small">
                            <i class="bi bi-zoom-in"></i> <?php echo e(__('messages.click_to_enlarge')); ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if($patient->xray_photo): ?>
                        <div class="form-text text-warning">
                            <i class="bi bi-exclamation-triangle me-1"></i><?php echo e(__('messages.xray_replace_hint')); ?>
...
<?php endif; ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $patient)): ?>
        <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'editToothModal','title' => __('messages.edit_tooth_chart'),'size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'editToothModal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.edit_tooth_chart')),'size' => 'lg']); ?>
