...
<?php endif; ?>
                                            <div class="mb-3">
                                                ...
                                                <textarea name="working_hours" class="form-control" rows="3" placeholder="<?php echo e(__('messages.working_hours_placeholder')); ?>" dir="ltr"><?php echo e(old('working_hours', $doctor->working_hours)); ?></textarea>
...
<?php endif; ?>
                <div class="mb-3">
                    <label class="form-label"><?php echo e(__('messages.working_hours')); ?></label>
                    <textarea name="working_hours" class="form-control" rows="3" placeholder="<?php echo e(__('messages.working_hours_placeholder')); ?>" dir="ltr"><?php echo e(old('working_hours')); ?></textarea>
                    <div class="form-text"><?php echo e(__('messages.working_hours_hint')); ?></div>
                </div>
                <div class="mb-3">
                    <label class="form-label"><?php echo e(__('messages.photo')); ?></label>
