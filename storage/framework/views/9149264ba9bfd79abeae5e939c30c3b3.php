...
<div class="d-flex">
   <?php
    $navItems = [
        ...
        ['route' => 'agenda.index', 'icon' => 'bi-calendar2-week', 'label' => __('agenda.title')],
        ...
        ['route' => 'finance.index',  'icon' => 'bi-cash-coin', 'label' => __('dental_navigation.finance') ],
        ['route' => 'suppliers.index', 'icon' => 'bi-truck', 'label' => __('dental_navigation.procurement'),],
        ['route' => 'purchases.index',  'icon' => 'bi-cart-check', 'label' => __('dental_navigation.purchases') ],
