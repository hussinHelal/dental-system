                ...
                <div class="row">
                    <div class="mb-3 col-md-6 position-relative">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               autocomplete="off"
                               placeholder="<?php echo e(__('messages.select_patient')); ?>"
                               value="<?php echo e($bookForName ?? ''); ?>"
                               required>
                        <input type="hidden" name="patient_id" id="appointmentPatientId" value="<?php echo e($bookFor); ?>">
                        <div id="appointmentPatientResults"
                             class="list-group position-absolute w-100 shadow-sm"
                             style="z-index: 1060; max-height: 220px; overflow-y: auto; display: none;"></div>
                        <div class="invalid-feedback"><?php echo e(__('messages.select_patient_from_list')); ?></div>
                    </div>
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal67ad07a4b593e690d435fee92e6413bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67ad07a4b593e690d435fee92e6413bb = $attributes; } ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderResults(patients) {
        if (!patients.length) {
            resultsBox.innerHTML = `<div class="list-group-item text-secondary"><?php echo e(__('messages.no_results')); ?></div>`;
    ...
    searchInput.addEventListener('input', function () {
        ...
        debounceTimer = setTimeout(() => {
            lastQuery = query;
            fetch(`<?php echo e(route('patients.search')); ?>?q=${encodeURIComponent(query)}`, {
