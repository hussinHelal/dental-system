...
<?php $__env->startSection('content'); ?>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-3 shadow-sm p-3 rounded-4 zedan-page-header">
            ...
            <form method="GET" class="d-flex flex-wrap gap-2 flex-grow-1 justify-content-end">
                ...
                <?php if(request()->filled('search') || request()->filled('status')): ?>
                    <a class="btn btn-outline-secondary" href="<?php echo e(route('insurance.index')); ?>" title="<?php echo e(__('insurance.clear_filter')); ?>">
                        <i class="bi bi-x-lg"></i>
                    </a>
                <?php endif; ?>

                <button type="button" class="btn btn-primary text-nowrap" data-bs-toggle="modal" data-bs-target="#createInsuranceModal">
                    <i class="bi bi-plus-lg me-1"></i><?php echo e(__('insurance.add_contract')); ?>
        ...
        <div class="card zedan-card shadow-sm">
                    ...
                    <table class="table zedan-responsive-table mb-0 align-middle">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td data-label="<?php echo e(__('insurance.company_name')); ?>">
                                        <span class="fw-semibold"><?php echo e($contract->company_name ?: '-'); ?></span>
                                    </td>
                                    ...
                                    <td data-label="<?php echo e(__('insurance.status')); ?>">
                                        <span class="badge bg-<?php echo e($contract->status->badgeColor()); ?>"><?php echo e($contract->status->label()); ?></span>
                                    </td>
                                    <td data-label="<?php echo e(__('insurance.recorded_by')); ?>"><?php echo e($contract->creator?->name ?: '—'); ?></td>
                                    <td data-label="<?php echo e(__('insurance.actions')); ?>" class="text-end">
                                        <div class="d-inline-flex gap-1">
                                            <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editInsuranceModal<?php echo e($contract->id); ?>" title="<?php echo e(__('insurance.edit')); ?>">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <form action="<?php echo e(route('insurance.destroy', $contract)); ?>" method="POST" class="d-inline" onsubmit="return confirm('<?php echo e(__('insurance.confirm_delete')); ?>')">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button class="btn btn-sm btn-outline-danger" title="<?php echo e(__('insurance.delete')); ?>">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <?php echo e(__('insurance.no_records')); ?>
            ...
            <?php if($contracts->hasPages()): ?>
                <div class="card-footer bg-transparent border-0 pt-0 pb-3">
                    <?php echo e($contracts->withQueryString()->links('pagination::bootstrap-5')); ?>
    ...
    <?php $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('insurance.partials.edit-modal', ['contract' => $contract], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    <?php echo $__env->make('insurance.partials.create-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
