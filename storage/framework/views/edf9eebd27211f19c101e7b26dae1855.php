...
<div class="row g-3">
    <div class="col-md-6">
        <label class="form-label" for="labCasePatientSearch<?php echo e($case?->id ?? 'new'); ?>"><?php echo e(__('dental_labs.patient')); ?> <span class="text-danger">*</span></label>
        <div class="position-relative" data-patient-autocomplete data-endpoint="<?php echo e(url('/lab-cases/patient-lookup')); ?>">
            <input type="text"
...
<?php /**PATH C:\Users\hussin\Downloads\zedan-dental-clinic\zedan\resources\views/lab-cases/partials/fields.blade.php ENDPATH**/ ?>